...
class App:
    ...
    def switch(self):
        ...
        if self.name:
            ...
            # empty app name indicates blank screen for which we dimm header
            rect.fill = 0x000000
        for i in range(12):
...
while True:
    ...
    if position != last_position:
        ...
        # if it's changed, scroll the difference
        wheel_pos = 1 if position < last_position else -1
        macropad.mouse.move(wheel=wheel_pos)
